                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link" id="recordLabelJob-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Record Job</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link" id="recordMutasiBarang-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Record Mutasi Barang</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link" id="recordLabelEFI-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Record EFI</p>
                                    </a>
                                </li>
