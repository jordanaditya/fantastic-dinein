								...
								<div class="card card-xxl-stretch mb-5 mb-xxl-8">
									...
									<div class="card-header border-0 pt-6">
										...
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-boldest fs-1 text-dark">Menu</span>
											<span class="text-gray-400 mt-2 fw-bold fs-4">Semua Menu</span>
										</h3>
										<!--end::Card title-->
										<!--begin::Card toolbar-->
										<div class="card-toolbar">
											...
											<ul class="nav nav-pills">
												<li class="nav-item me-1">
													<a class="nav-link btn btn-active-light active btn-color-gray-400 btn-active-color-gray-700" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_chart_widget_1_tab_pane_1">Makanan</a>
												</li>
												<li class="nav-item">
													<a class="nav-link btn btn-active-light btn-color-gray-400 btn-active-color-gray-700" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_chart_widget_1_tab_pane_2">Minuman</a>
												</li>
												<li class="nav-item">
													<a class="nav-link btn btn-active-light btn-color-gray-400 btn-active-color-gray-700" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_chart_widget_1_tab_pane_3">Ringan</a>
												</li>
												<li class="nav-item">
								...
								<div class="card card-xxl-stretch">
									...
									<div class="card-body d-flex flex-column justify-content-between h-100">
										...
										<div class="pt-1">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-boldest fs-1 text-dark">Cart</span>
											</h3>
											<!--end::Title-->
										</div>
										<!--end::Section-->
				...
				<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container-fluid d-flex flex-column flex-md-row flex-stack">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">Fantastic Dine In</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Menu-->
